<?php 
	...
	class ProductosModel extends Mysql
	{
		...
		public function insertProducto(string $nombre, string $descripcion, int $codigo, int $categoriaid, 
		string $precio, int $stock, int $cantxdia, int $cantxmes, int $cantxannio, string $ruta, int $status){
			...
			$this->intStock = $stock;
			$this->intCantxDia = $cantxdia;
			$this->intCantxMes = $cantxmes;
			$this->intCantxAnnio = $cantxannio;
			$this->strRuta = $ruta;
		...
		int $categoriaid, string $precio, int $stock, int $cantxdia, int $cantxmes, int $cantxannio, string $ruta, int $status){
