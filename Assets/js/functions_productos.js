...
window.addEventListener('load', function() {
    if(document.querySelector("#formProductos")){
        ...
        formProductos.onsubmit = function(e) {
            ...
            let intCantxDia = document.querySelector('#txtCantxDia').value;
            let intCantxMes = document.querySelector('#txtCantxMes').value;
            let intCantxAnnio = document.querySelector('#txtCantxAnnio').value;
            let intStatus = document.querySelector('#listStatus').value;
            if(strNombre == '' || intCodigo == '' || strPrecio == '' || intStock == '' || intCantxDia == ''|| intCantxMes == ''|| intCantxAnnio == '' )
            {
                    ...
                    if(objData.status)
                    {
                        ...
                        if(rowTable == ""){
                           ...
                           htmlStatus = intStatus == 1 ? 
                            ...
                            rowTable.cells[3].textContent = intCantxDia;
                            rowTable.cells[3].textContent = intCantxMes;
                            rowTable.cells[3].textContent = intCantxAnnio;
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                ...
                document.querySelector("#celCantxDia").innerHTML = objProducto.cantxdia;
                document.querySelector("#celCantxMes").innerHTML = objProducto.cantxmes;
                document.querySelector("#celCantxAnnio").innerHTML = objProducto.cantxannio;
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                ...
                document.querySelector("#txtCantxDia").value = objProducto.cantxdia;
                document.querySelector("#txtCantxMes").value = objProducto.cantxmes;
                document.querySelector("#txtCantxAnnio").value = objProducto.cantxannio;
