...
class Clientes extends Controllers{
	...
	public function Clientes()
	{
		...
		$data['page_title'] = "CLIENTES <small>Llénate de emoción </small>";
	...
	public function setCliente(){
		error_reporting(0);
		if($_POST){
			if(empty($_POST['txtIdentificacion']) || empty($_POST['txtNombre']) || empty($_POST['txtApellido']) || empty($_POST['txtTelefono']) || empty($_POST['txtEmail']) || empty($_POST['dateFechaNacimiento']) || empty($_POST['dateFechaIngreso']) )
			{
				...
				$strFechaNacimiento = strClean($_POST['dateFechaNacimiento']);
				$strFechaIngreso = strClean($_POST['dateFechaIngreso']);
				$intRolId = 3;
				$request_user = "";
				if($idUsuario == 0)
				{
