    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="container-title">
              <h3 class="tile-title">Beneficios Usados por mes</h3>
              <div class="dflex">
        ...
        <div class="col-md-12">
          <div class="tile">
            <div class="container-title">
              <h3 class="tile-title">Beneficios por año</h3>
              <div class="dflex">
...
<script>
  ...
  Highcharts.chart('graficaMes', {
      ...
      title: {
          text: 'Beneficios de <?= $data['ventasMDia']['mes'].' del '.$data['ventasMDia']['anio'] ?>'
      },
      subtitle: {
          text: 'Total Beneficio <?= SMONEY.'. '.formatMoney($data['ventasMDia']['total']) ?> '
      },
      xAxis: {
          categories: [
            <?php 
  ...
  Highcharts.chart('graficaAnio', {
      ...
      title: {
          text: 'Beneficios del año <?= $data['ventasAnio']['anio'] ?> '
      },
      subtitle: {
          text: 'Esdística de beneficios por mes'
      },
      xAxis: {
          type: 'category',
          labels: {
