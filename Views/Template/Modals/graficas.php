...
<script>
	  Highcharts.chart('graficaMes', {
	      ...
	      title: {
	          text: 'Beneficios usados en <?= $ventasMes['mes'].' del '.$ventasMes['anio'] ?>'
	      },
	      subtitle: {
	          text: 'Total beneficios <?= SMONEY.'. '.formatMoney($ventasMes['total']) ?> '
	      },
	      xAxis: {
	          categories: [
	            <?php 
 ...
 <script>
 	Highcharts.chart('graficaAnio', {
      ...
      title: {
          text: 'Beneficios usados en el año <?= $ventasAnio['anio'] ?> '
      },
      subtitle: {
