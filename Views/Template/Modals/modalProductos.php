            ...
            <form id="formProductos" name="formProductos" class="form-horizontal">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label class="control-label">Cantidad por día <span class="required">*</span></label>
                            <input class="form-control" id="txtCantxDia" name="txtCantxDia" type="text" required="">
                        </div>
                        <div class="form-group col-md-6">
                            <label class="control-label">Cantidad por mes <span class="required">*</span></label>
                            <input class="form-control" id="txtCantxMes" name="txtCantxMes" type="text" required="">
                        </div>
                        <div class="form-group col-md-6">
                            <label class="control-label">Cantidad por año <span class="required">*</span></label>
                            <input class="form-control" id="txtCantxAnnio" name="txtCantxAnnio" type="text" required="">
                        </div>
                    </div>
      ...
      <div class="modal-body">
        <table class="table table-bordered">
          <tbody>
            ...
            <tr>
              <td>Cantidad por dia:</td>
              <td id="celCantxDia"></td>
            </tr>
            <tr>
              <td>Cantidad por mes:</td>
              <td id="celCantxMes"></td>
            </tr>
            <tr>
              <td>Cantidad por año:</td>
              <td id="celCantxAnnio"></td>
            </tr>
            <tr>
              <td>Categoría:</td>
