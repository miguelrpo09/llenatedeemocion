              ...
              <table class="table table-bordered">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td>Fecha a utilizar beneficio:</td>
                          ...
                          <td>
                            ...
                            <input type="text" name="txtTransaccion" id="txtTransaccion" class="form-control" value="<?= $data['orden']['referenciacobro'] ?>" required="" placeholder= "dd/mm/aaaa">
                            ...
                            ?>
                              ...
                              <select name="listTipopago" id="listTipopago" class="form-control selectpicker" data-live-search="true" required="">
                                  ...
                                  <?php 
                                    ...
                                    for ($i=1; $i < count($data['tipospago']) ; $i++) {
