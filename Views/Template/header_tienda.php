	...
	<header>
					...
					<div class="menu-desktop">
						...
						<ul class="main-menu">
							...
							<li class="active-menu">
								...
								<a href="<?= base_url(); ?>/tienda">Inicio</a>
							...
							<li>
								...
								<a href="<?= base_url(); ?>/nosotros">Convenios</a>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				...
				<a href="<?= base_url(); ?>"><img src="<?= media() ?>/tienda/images/logo.png" alt="Tienda Llenate de emoción"></a>
