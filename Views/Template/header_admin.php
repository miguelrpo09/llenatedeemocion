...
<html lang="es">
  ...
  <head>
    ...
    <meta name="description" content="Llenate de emoción Miguel Restrepo">

    <meta http-equiv="X-UA-Compatible" content="IE=edge">

    <meta name="viewport" content="width=device-width, initial-scale=1">

    <meta name="author" content="Miguel Restrepo">
  ...
  <body class="app sidebar-mini">
    ...
    <header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard"><img src="<?= media();?>/images/logo.png" style="width:80%;" alt=""></a>
