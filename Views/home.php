			...
			if(count($arrProductos) > 0 ){
				...
				for ($p=0; $p < count($arrProductos); $p++) {
					...
					if(!isset($arrProductos[$p]['CantTotalUtilizadaAnno'])){
						...
						$CantUtilizadasAnno=($arrProductos[$p]['CantTotalUtilizadaAnno']==null)?0:$arrProductos[$p]['CantTotalUtilizadaAnno'];
					}
					...
					if(!isset($arrProductos[$p]['CantTotalUtilizadaMes'])){
						...
						$CantUtilizadaMes=($arrProductos[$p]['CantTotalUtilizadaMes']==null)?0:$arrProductos[$p]['CantTotalUtilizadaMes'];
					}
					if(!isset($arrProductos[$p]['CantTotalUtilizadaDia'])){
						$CantUtilizadaDia=0;
					}else{
						$CantUtilizadaDia=($arrProductos[$p]['CantTotalUtilizadaDia']==null)?0:$arrProductos[$p]['CantTotalUtilizadaDia'];
					}
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								...
								<?php if ($disponibleAnnio > 0 && $disponibleMes > 0 && $disponibleDia > 0){?>
									Disponibles en el año <span class="badge badge-success px-3 py-2" > <?php  echo (isset($_SESSION['idUser'])>0)? $disponibleAnnio: 'Inicie sesión' ?></span> 
								 <?php } else {?>
