						...
						<div class="wrap-table-shopping-cart">
							<table id="tblCarrito" class="table-shopping-cart">
								<tr class="table_head">
									...
									<th class="column-3">Valido por</th>
									<th class="column-4" style="text-align: center;">Cantidad</th>
							...
							<?php 
							 ...
							 ?>
								<tr class="table_row <?= $idProducto ?>">
									...
									<td class="column-3" style="text-align: center;"><?= /* SMONEY.formatMoney */$producto['cantidad'] ?></td>
									<td class="column-4">
										<div class="wrap-num-product flex-w m-l-auto m-r-0">
											...
											<input class="mtext-104 cl3 txt-center num-product" type="number" name="num-product1" id="<?= $idProducto ?>" value="<?= $producto['cantidad'] ?>" idpr="<?= $idProducto ?>">
...
<br>
<div class="container">
	<p>No hay beneficios en el carrito <a href="<?= base_url() ?>/tienda"> Ver beneficios</a></p>
</div>
<br>
<?php 
	}
