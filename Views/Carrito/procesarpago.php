				...
				<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-l-25 m-r--38 m-lr-0-xl">
					...
					?>
						...
						<div>
							...
							<label for="tipopago">Lugar de trabajo</label>

							<div class="bor8 bg0 m-b-12">

								<select class="stext-111 cl8 plh3 size-111 p-lr-15" name="state" id="txtDireccion" >

									<option value="" selected disabled="disabled">Seleccioné uno</option>

									<option value="Bodega 108">Bodega 108</option>

									<option value="Doppler Fabricato">Doppler Fabricato</option>

									<option value="Doppler Mayorca">Doppler Mayorca</option>

									<option value="Doppler Molinos">Doppler Molinos</option>

									<option value="Doppler Santa Fe">Doppler Santa Fe</option>

									<option value="Doppler Tesoro">Doppler Tesoro</option>

									<option value="Doppler Viva Envigado">Doppler Viva Envigado</option>

									<option value="Giant Liv Outlet">Giant Liv Outlet</option>

									<option value="Giant Liv Poblado">Giant Liv Poblado</option>
								...
								<!-- <input id="txtDireccion" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="state" placeholder="Lugar de trabajo"> -->
						...
						<div id="optMetodoPago" class="notblock">	
							...
							<div class="divmetodpago">
								...
								<div id="divtipopago" class="notblock" >
									...
									<button type="submit" id="btnComprar" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">Procesar Beneficio</button>
